...
.map-container h3 { margin-bottom: 0.5rem; color: var(--text-color); }

.map { height: 400px; width: 100%; border-radius: 10px; border: 1px solid var(--edge); box-shadow: var(--shadow); }
</style>
